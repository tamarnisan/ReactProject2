...
return(
<div>
<button disabled= {props.i===props.index ? false : true} onClick={()=>
...
<button disabled={props.i===props.index? false : true} onClick={()=>{props.setNumber(props.randomNum-1)
 props.setCount(props.count+1);
 props.setIndex((prev) => prev===props.length-1? prev=0:prev +1)
 ishundrend(props.randomNum-1)}}>-1</button>

<button disabled={props.i===props.index ? false : true} onClick={()=>{props.setNumber(props.randomNum*2)
    props.setCount(prev => prev +1);
    props.setIndex((prev) => prev===props.length-1? prev=0:prev +1)
